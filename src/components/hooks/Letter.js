        ...
        >
            ...
            >
                <Typography variant="body1" sx={{ pl: 1, pr: 1, mb:5, fontStyle:"italic" }}>
                    ...
                    <br/>
                    <br/>
                    Mấy năm học cấp ba đã kết thúc, tớ chẳng biết nói gì nữa, thôi thì ngồi ôn lại những gì đã từng là kỉ niệm. Kỉ niệm đáng nhớ nhất của chúng ta là đây:
                    <br/>
                    {data.memories}
                    <br/>
                    <br/>
                    ...
                    <br/>
                    <br/>
                    Hết rùi nè, mong rằng chiếc lưu bút này sẽ gửi tới được cậu. Thôi thì chúc cậu thành công =)))).
                    <br/>
                    <br/>
                    Kí tên
                    <br/>
